...
%JAVA% -server %JAVA_OPTS% %JAVA_OPTS_SCRIPT% -Dfile.encoding=UTF-8 -Dlog4j.configuration=file:%LOG_FILE% -Dmoquette.path=%MOQUETTE_PATH% -cp %MOQUETTE_HOME%\lib\* io.moquette.server.Server
