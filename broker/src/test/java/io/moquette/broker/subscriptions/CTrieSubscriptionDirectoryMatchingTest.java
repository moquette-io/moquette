...
public class CTrieSubscriptionDirectoryMatchingTest extends CTrieSubscriptionDirectMatchingCommon {
    ...
    public void testRecursionOnInsertion() {
        ...
        boolean result = sut.add("attacker-client", asTopic(deepTopic), MqttSubscriptionOption.onlyFromQos(MqttQoS.AT_MOST_ONCE));
        
        assertFalse(result, "Add should log a warn and terminate with false"); // exercises CTrie.insert()/createPathRec()
    }
