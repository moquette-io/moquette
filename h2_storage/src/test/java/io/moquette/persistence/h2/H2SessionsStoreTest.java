...
public class H2SessionsStoreTest {
    ...
    public void testQueryByExpirationDate() {
        ...
        sessionsStore.trackOpenSession(sessionCreationTime, "Sensor1");

        LocalDateTime session2CreationTime = LocalDateTime.of(2017, 11, 1, 10, 0, 0);
        sessionsStore.trackOpenSession(session2CreationTime, "Sensor2");
...
//            sessionsStore.trackOpenSession(timePin, "Sensor" + i);
//        }
