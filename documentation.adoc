...
https://bintray.com/artifact/download/andsel/generic/moquette-0.12.tar.gz[BinTray]
then un ```tar zxf moquette-0.12.tar.gz``` and start the broker listening on 1883 port and enjoy!
```
tar zxf moquette-0.12.tar.gz
cd bin
./moquette.sh
```
